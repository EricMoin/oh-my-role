...
- **Budget assessment first.** Before lighting a new department, estimate: how many subtasks will it handle per request? What model does it need? DeepSeek V4 Pro Max for precision work, DeepSeek V4 Flash for routing?
