...
- **tests**: {passed / failed — include command and result}
...
- **Verification Evidence**: Always include the actual tool name and result. If tests passed, show the command and output. If you didn't run tests, say so — do not guess.
